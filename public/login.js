...
document.addEventListener('DOMContentLoaded', () => {          
    ...
    loginForm.addEventListener('submit', (event) => {
        ...
        let reqBody = JSON.stringify({                 //da JSON.stringify method converts js object into a JSON string 
            username: username,
            password: password,
            remember: rememberMe
        });
        ...
        /* sendin a POST Request*/
        // send another request to /login, but using POST instead.
        fetch('/login', {
            method: 'POST',
            headers: { 
